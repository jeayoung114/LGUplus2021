...
# https://github.com/rixwew/pytorch-fm/blob/master/torchfm/model/nfm.py을 참고했습니다.
class NFM_implicit(torch.nn.Module):
    ...
    def build_graph(self):
        ...
        self.mlp = MultiLayerPerceptron(self.embed_dim, self.mlp_dims, self.dropout)
