...
# https://github.com/rixwew/pytorch-fm/blob/master/torchfm/model/lr.py을 참고했습니다.
class LR_implicit(torch.nn.Module):
    def __init__(self, train_data, train_label, valid_data, valid_label, field_dims, 
    ...
    def forward(self, x):
        ...
        output = torch.sigmoid(first.squeeze(1))
        return output
